##Uèitava se numpy i OpenCV
import numpy as np
import cv2

#Uèitavanje Haar-ovih kaskada
...
for i in range(len(slike)):
    #Uèitavanje slike i pretvaranje slike u sivu
    naziv_slike = slike[i]
    img = cv2.imread(naziv_slike)
    gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)

    #traži se odreðeni dijelovi lica i uokviruju se razlièitim bojama
